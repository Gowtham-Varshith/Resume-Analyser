...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://tr-portfolio-tan.vercel.app/" style="text-decoration: none; color: red;">Vignesh</a></b>' 
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                ds_keyword = [
                    ...
                    'data analysis', 'data visualization', 'flask', 'streamlit'
                ]

                # Web Development Keyword
                web_keyword = [
                    'html', 'css', 'javascript', 'react', 'angular', 'vue.js', 
                    'django', 'flask', 'node.js', 'express.js', 'php', 
                    'laravel', 'wordpress', 'magento', 'asp.net', 'ruby on rails'
                ]

                # Android Development Keyword
                android_keyword = [
                    'android', 'kotlin', 'java', 'android studio', 'xml', 
                    'flutter', 'firebase', 'material design', 'mvvm', 'jetpack compose'
                ]

                # iOS Development Keyword
                ios_keyword = [
                    'ios', 'swift', 'objective-c', 'xcode', 'cocoa touch', 
                    'core data', 'cocoa pods', 'ui kit', 'mvvm', 'swiftui'
                ]

                # UI/UX Design Keyword
                uiux_keyword = [
                    'ui', 'ux', 'figma', 'adobe xd', 'sketch', 
                    'prototyping', 'wireframing', 'user research', 'interaction design', 'visual design', 
                    'adobe photoshop', 'adobe illustrator', 'adobe after effects', 'adobe premiere pro', 'adobe indesign', 
                    'user experience', 'user interface', 'responsive design', 'typography', 'branding'
                ]

                # General Skills Keyword
                n_any = [
                    'english', 'communication', 'teamwork', 'leadership', 'project management', 
                    'critical thinking', 'problem solving', 'time management', 'customer service', 'social media management'
                ]
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - RESUME ATS ANALYZER**")

        st.markdown('''

        <div align='justify'>
            <h2>Revolutionize Your Job Search:</h2>
            <p>Introducing an innovative tool designed to transform your resume into actionable insights:</p>
            <ul>
                <li><strong>Advanced Parsing Capabilities:</strong> Leveraging the power of natural language processing, our tool delves deep into your resume, extracting essential keywords and phrases.</li>
                <li><strong>Strategic Keyword Clustering:</strong> It doesn't just stop at identification; our tool categorizes these keywords into relevant industry sectors, providing context and clarity.</li>
                <li><strong>Tailored Recommendations:</strong> Beyond mere analysis, receive personalized recommendations, future-oriented predictions, and detailed analytics, all based on sophisticated keyword matching techniques.</li>
            </ul>
            <p>Empower your job application with a tool that not only understands the nuances of your resume but also guides you towards your professional aspirations.</p>
        </div>
       ...
       <div align="justify">
            ...
            <h3>For Users:</h3>
            <ul>
                <li><strong>Step into the Spotlight:</strong> In the Side Bar, select "User" to access your profile. Fill in the necessary fields to tailor your experience.</li>
                <li><strong>Resume Upload:</strong> Upload your resume in PDF format. Then, relax; our tool will automatically analyze your document.</li>
                <li><strong>Await the Magic:</strong> Sit back while our system evaluates your resume, providing personalized insights and recommendations.</li>
            </ul>
            <h3>Share Your Thoughts:</h3>
            <p>We value your feedback! Share your thoughts and suggestions to help us enhance your experience.</p>
        </div>

        <p align="justify">
            Built with 🤍 by 
            <a href="https://tr-portfolio-tan.vercel.app/" style="text-decoration: none; color: grey;">Vignesh</a> 
        </p>
